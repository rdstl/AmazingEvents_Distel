// URL de la API de Amazing Events
...
// Utilizamos la función fetch para hacer una solicitud GET a la API
/* fetch(apiUrl)
  .then(response => 
   {
    // La API respondió, ahora procesamos la respuesta
    if (!response.ok) 
    {
  ...
  .then(data => {
    // Hacemos algo con los datos obtenidos, por ejemplo, imprimirlos en la consola
   const dataz =data;
